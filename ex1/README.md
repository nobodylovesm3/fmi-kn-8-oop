...
Може ли да се направи да работи за произволен тип (use templates!)
...
Вашата задача е да създадете C ++ клас, наречен Grade, който има същата функционалност като старата struct Grade и свързаните с него функции в оригиналния C файл. Когато приключите, вашият C ++ файл трябва да има само една дефиниция на функция извън класа: main (). Трябва да използвате следната дефиниция на main: 
```
int main() { 	
    Grade g; 	
    int percent;
